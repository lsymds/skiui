...
- `skiui apply` syncs repositories and links enabled skills into enabled assistants (git sources are cached, filesystem sources are linked directly from source paths, and overlapping source/destination paths are rejected).
