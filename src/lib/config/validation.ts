...
export function parseSkiuiConfig(rawConfig: unknown, sourceLabel: string): SkiuiConfig {
  ...
  if (!parsed.success) {
    ...
    throw new ConfigValidationError(`Invalid config in ${sourceLabel}: ${details}`);
  }
