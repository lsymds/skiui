...
function defineAssistant(
	id: string,
	input: AssistantDefinitionInput,
): AssistantDefinition {
...
export const ASSISTANT_DEFINITIONS: AssistantDefinition[] = [
	...
	defineAssistant("antigravity", {
		...
		rulePaths: [".agent/rules/ruler.md"],
	}),
	defineAssistant("amazonqcli", {
		rulePaths: [".amazonq/rules/ruler_q_rules.md"],
	}),
	defineAssistant("aider", { rulePaths: ["AGENTS.md", ".aider.conf.yml"] }),
	defineAssistant("firebase", { rulePaths: [".idx/airules.md"] }),
	defineAssistant("openhands", {
		rulePaths: [".openhands/microagents/repo.md"],
	}),
	...
	defineAssistant("augmentcode", {
		rulePaths: [".augment/rules/ruler_augment_instructions.md"],
	}),
	...
	defineAssistant("kiro", {
		rulePaths: [".kiro/steering/ruler_kiro_instructions.md"],
	}),
...
export function createDefaultAssistantsConfig(): Record<
	string,
	AssistantStatus
> {
	return ASSISTANT_DEFINITIONS.reduce<Record<string, AssistantStatus>>(
		(result, assistant) => {
...
export function getAssistantSkillPathsForScope(
	assistant: AssistantDefinition,
	scope: Scope,
): string[] {
	return scope === "global"
		? assistant.globalSkillPaths
		: assistant.projectSkillPaths
}

export function getAssistantRulePathsForScope(
	assistant: AssistantDefinition,
	scope: Scope,
): string[] {
	return scope === "global"
		? assistant.globalRulePaths
		: assistant.projectRulePaths
}
